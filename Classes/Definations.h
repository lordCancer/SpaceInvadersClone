...
#define ENEMY_MOVE_INTERVAL 0.4
#define ENEMY_DELTA_X 10.0
#define ENEMY_DELTA_Y 20.0
#define ENEMY_MOVE_ELAPSED_TIME 0.0
#define ENEMY_MISSILE_INTERVAL_MAX 7
#define ENEMY_MISSILE_INTERVAL_MIN 3
#define ENEMY_SCORE_VALUE 10

#define SHIELD_TOTAL 3
#define SHIELD_HEALTH 3
#define TOTAL_ENEMY ENEMY_ROW_COUNT * ENEMY_COLUMN_COUNT
